            ...
            <div className="flex flex-col border-b border-gray-600">
                <div className="flex mt-12 md:mt-20 lg:mt-24 mb-12 flex-row justify-between">
                    ...
                    <div className="flex flex-row space-x-8 items-center justify-between">
                        <a>
                            <svg width="12" height="18" viewBox="0 0 6 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a href="https://www.youtube.com/channel/UCjtCbnkIaiCJgj13sEZ9iqw">
                            <svg width="19" height="15" viewBox="0 0 13 9" fill="none" xmlns="http://www.w3.org/2000/svg">
